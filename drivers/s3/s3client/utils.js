...
exports.to_query_string = function(options) {
    ...
    var filter = ['acl', 'notification', 'partNumber', 'policy', 'requestPayment', 'torrent',
        'uploadId', 'uploads', 'versionId', 'versioning', 'versions', 'website', 'prefix',
        'max-keys', 'marker', 'delimiter', 'location', 'logging', 'response-content-type',
