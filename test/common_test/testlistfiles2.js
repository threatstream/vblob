...
var suite = vows.describe('testlistfiles2: using container ' + container_name + ' against driver ' +
...
suite.addBatch({
    ...
    */
    ...
    'PUT container/photos/2006/January/sample.jpg': {
        topic: api.put_data(container_name + '/photos/2006/January/sample.jpg',
            './file1.txt'),
        'should respond with a 200 OK': assertStatus(200),
        'should respond with the md5 hex of the file': function(err, res) {
            assert.isString(res.headers.etag);
    ...
    'PUT container/photos/2006/February/sample2.jpg': {
        topic: api.put_data(container_name + '/photos/2006/February/sample2.jpg',
            './file1.txt'),
        'should respond with a 200 OK': assertStatus(200),
        'should respond with the md5 hex of the file': function(err, res) {
            assert.isString(res.headers.etag);
    ...
    'PUT container/photos/2006/February/sample3.jpg': {
        topic: api.put_data(container_name + '/photos/2006/February/sample3.jpg',
            './file1.txt'),
        'should respond with a 200 OK': assertStatus(200),
        'should respond with the md5 hex of the file': function(err, res) {
            assert.isString(res.headers.etag);
    ...
    'PUT container/photos/2006/February/sample4.jpg': {
        topic: api.put_data(container_name + '/photos/2006/February/sample4.jpg',
            './file1.txt'),
        'should respond with a 200 OK': assertStatus(200),
        'should respond with the md5 hex of the file': function(err, res) {
            assert.isString(res.headers.etag);
    ...
    'TOPLEVEL': {
        ...
        'GET container?delimiter=/': {
            ...
            'should respond with a valid list of prefixes or a valid error': function(err,
                res) {
