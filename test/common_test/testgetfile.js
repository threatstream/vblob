...
var suite = vows.describe('testgetfile: using container ' + container_name + ' against driver ' +
...
suite.addBatch({
    ...
    'GET container/testgetfile-1.txt if-unmodified-since past': {
        topic: api.get_data(container_name + '/testgetfile-1.txt', {
            'if-unmodified-since': new Date(new Date().valueOf() - 500000).toUTCString()
        }),
    ...
    'GET container/testgetfile-1.txt if-modified-since past': {
        topic: api.get_data(container_name + '/testgetfile-1.txt', {
            'if-modified-since': new Date(new Date().valueOf() - 500000).toUTCString()
        }),
        'should respond with 200': assertStatus(200),
        'should have body and length': function(err, res) {
            assert.isNotNull(res.resp_body);
    ...
    'GET container/testgetfile-1.txt response-content-type': {
        topic: api.get_data(container_name +
            '/testgetfile-1.txt?response-content-type=application/javascript'),
        'should respond with 200': assertStatus(200),
    ...
    'GET container/testgetfile-1.txt response-content-language': {
        topic: api.get_data(container_name +
            '/testgetfile-1.txt?response-content-language=mi%2C%20en'),
        'should respond with 200': assertStatus(200),
    ...
    'GET container/testgetfile-1.txt response-content-disposition': {
        topic: api.get_data(container_name +
            '/testgetfile-1.txt?response-content-disposition=attachment%3B%20filename%3Dtesting.txt'
        ),
        'should respond with 200': assertStatus(200),
    ...
    'GET container/testgetfile-1.txt response-content-encoding': {
        topic: api.get_data(container_name +
            '/testgetfile-1.txt?response-content-encoding=x-gzip'),
        'should respond with 200': assertStatus(200),
    ...
    'GET container/testgetfile-1.txt response-cache-control': {
        topic: api.get_data(container_name +
            '/testgetfile-1.txt?response-cache-control=No-cache'),
        'should respond with 200': assertStatus(200),
    ...
    'GET container/testgetfile-1.txt response-expires': {
        topic: api.get_data(container_name +
            '/testgetfile-1.txt?response-expires=Thu%2C%2001%20Dec%201994%2016:00:00%20GMT'
        ),
        'should respond with 200': assertStatus(200),
